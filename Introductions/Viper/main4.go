...
func main() {
    ...
    flag.Parse()
    viper.SetDefault("webserver.endpoint", "https://httpbin.org/get") // Setting default means the value can be overwritten.
    viper.SetDefault("webserver.name", "Testing Endpint")
    viper.AddConfigPath(".")
